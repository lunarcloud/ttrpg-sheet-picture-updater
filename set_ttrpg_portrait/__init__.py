...
try:
    ...
    # overwrites that file from the "release/#" or "v#.#.#" git tag before
    # building (see packaging/lib/compute-version.sh) — locally it's always
    # "0.0.0". Re-run `./setup.sh` (or `pip install -e .`) after it changes
    # so this picks it up.
